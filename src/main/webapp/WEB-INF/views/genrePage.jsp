    	...
    	<c:when test="${!empty categoryList}">
			<section class="s-content" style="padding-top: 10rem;">
		        <div class="row entries-wrap wide">
		        	<p style="font-family:'Jua',sans-serif;text-align: center;">CATEGORY:${category}</p>
		            <div class="entries">
			                            ...
			                            <div class="item-entry__cat">
					                        <c:choose>
			                                	<c:when test="${'Rap-Hip-hop' eq category.genre }">
			                                		<a href="/category/genre/${category.genre}">Rap/Hip-hop</a>
			                                	</c:when>
			                                	<c:when test="${'R&B-Soul' eq category.genre }">
			                                		<a href="/category/genre/${category.genre}">R&B/Soul</a>
			                                	</c:when>
			                                	<c:when test="${'Rap-Hip-hop' ne category.genre && 'R&B-Soul' ne category.genre}">
			                                		<a href="/category/genre/${category.genre}">${category.genre}</a>
			                                	</c:when>
			                                </c:choose>
			                            </div>
		        ...
		        <div class="row pagination-wrap">
					<div class="col-full">
						<nav class="pgn" data-aos="fade-up">
							...
							<form action="/category/genre/${category}" method="post" id='frmPaging'>
