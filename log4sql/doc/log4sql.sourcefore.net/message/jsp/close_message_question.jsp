...
/**
 * User: songinsup
 * Date Time: 2008. 1. 12 오후 12:22:38
 * Content : 
 */
--%>
...
<HTML>
<HEAD>
<TITLE> ::: INFO QUESTION MESSAGE ::: </TITLE>
<link rel="STYLESHEET" type="text/css"
    ...
    var btnTextConfirm=argArray[0];
    var btnTextCancel=argArray[1];
    var msgText=argArray[2];
    var itemName1=argArray[3];
    var itemName2=argArray[4];
    var itemName3=argArray[5];
    if(itemName1 != '') {
                    ...
                    <TR>
                        <TD align="center" bgcolor="#FFFFFF"
                            ...
                            <TABLE width="335" cellpadding="0" cellspacing="0"
                                        ...
                                        <TABLE cellpadding="0" cellspacing="0"
                                            ...
                                            <TR>
                                                <TD width="45" valign="middle"
                                                    align="center"
                                                    class="message"><IMG
                                                        src="/sqlmapper/message/image/bu_confirm4.gif"
                                                        width="32" height="32"
                                                        border="0"></TD>
                                                <TD width="20"><IMG
                                                        src="/sqlmapper/message/image/spacer.gif"
                                    ...
                                    <TD bgcolor="#FFFFFF" align="center"
                                        ...
                                        <TABLE cellpadding="0" cellspacing="0"
                                            ...
                                            <TR>
                                                <TD align='center'
                                                    ...
                                                    <TABLE border='0'
                                                        ...
                                                        <TR>
                                                            ...
                                                            <TD bgcolor='#E3EAEF'
                                                                align='center'
                                                                valign='bottom'><SCRIPT>document.write(btnTextConfirm);</SCRIPT></TD>
                                                        </TR>
                                                        <TR>
                                                            <TD colspan='2'
                                                ...
                                                <!--/TD>
                                                <TD width="5"><IMG src="/sqlmapper/message/image/spacer.gif" width="5" height="1"></TD>
                                                <TD align='center' class='left_menu' valign='bottom'>
                                                    <TABLE border='0' cellspacing='0' cellpadding='0' height='19' class='left_menu' onClick="javascript:cancel();" style='cursor:hand' >
                                                        <TR>
                                                            <TD rowspan='3' align='right'><IMG src='/sqlmapper/message/image/button_left01.gif' width='6' height='21'></TD>
                                                            <TD background='/sqlmapper/message/image/button_center01.gif'><IMG src='/sqlmapper/message/image/spacer.gif' width='1' height='1'></TD>
                                                            <TD height='3' background='/sqlmapper/message/image/button_center01.gif'><IMG src='/sqlmapper/message/image/spacer.gif' width='1' height='3'></TD>
                                                            <TD rowspan='3'><IMG src='/sqlmapper/message/image/button_right01.gif' width='6' height='21'></TD>
                                                        </TR>
                                                        <TR>
                                                            <TD bgcolor='#E3EAEF' width='15'><IMG src='/sqlmapper/message/image/bu_cancel.gif' border='0'></TD>
                                                            <TD bgcolor='#E3EAEF' align='center' valign='bottom'><SCRIPT>document.write(btnTextCancel);</SCRIPT></TD>
                                                        </TR>
                                                        <TR>
                                                            <TD colspan='2' background='/sqlmapper/message/image/button_center02.gif'><IMG src='/sqlmapper/message/image/spacer.gif' width='1' height='2'></TD>
                                                        </TR>
                                                    </TABLE-->
                                                </TD>
                                            </TR>
                                ...
                                <TR height="10">
                                    <TD bgcolor="#FFFFFF"><IMG
                                            src="/sqlmapper/message/image/spacer.gif"></TD>
                                </TR>
                            </TABLE>
                        </TD>
                    </TR>
